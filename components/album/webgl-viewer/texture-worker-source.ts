/**
 * Texture worker source code as a string for inline Blob Worker creation.
 * This avoids SSR issues (self is not defined) and eliminates extra network requests.
 *
 * @reference https://github.com/Afilmory/afilmory
 */

// eslint-disable-next-line quotes
export const TextureWorkerSource = `
